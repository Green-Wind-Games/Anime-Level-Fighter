...
Invert the horizontal commands if your character is facing left.
Most moves can be done both in the ground or in the air.
...
Tap any direction (while getting pummeled/held): Struggle to Escape
Tap A/B/C (while pummeling/holding): Increase Grab Damage
...
236C+D: Ultimate Finisher (Costs 5-7 MP)
214C+D (some characters): Secret Finisher (Costs near-max MP, usable only once)
...
-Parry attacks, which, while risky, prevents all damage and gives you a window to counter-attack.
...
Certain Special moves can use TP to increase the distance covered.
...
Certain characters can transform when Leveling Up, which changes their appearance, moveset and abilities.
