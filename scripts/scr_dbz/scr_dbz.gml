...
part_type_color3(kiblast_yellow_particle,c_white,make_color_rgb(255,255,128),c_black);
...
part_type_color3(kiblast_purple_particle,c_white,make_color_rgb(0,192,255),c_black);
...
function add_kiblast_state(_maxrepeats,_sprite1,_sprite2,_kiblastparticle) {
